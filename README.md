...
- [ ] **Desktop Application Frame**: Initialize the desktop application frame (Tauri / WebView shell).
- [ ] **Map Canvas Embedding**: Embed MapLibre GL JS into the primary UI canvas.
...
- [ ] **Native Desktop Integration**: Implement native File Menu with a functioning **Quit** action to close the application cleanly.
